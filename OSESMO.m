...
Load_Profile_Data = Import_Load_Profile_Data(Box_Sync_Directory_Location, OSESMO_Git_Repo_Directory, delta_t, Load_Profile_Name_Input);
...
Marginal_Emissions_Rate_Forecast_Data = Import_Marginal_Emissions_Rate_Forecast_Data(Box_Sync_Directory_Location, OSESMO_Git_Repo_Directory, ...
    delta_t, Load_Profile_Data, Emissions_Forecast_Signal_Input);


% Import Marginal Emissions Rate Data Used for Evaluation
% Call Import_Marginal_Emissions_Rate_Forecast_Data function.
Marginal_Emissions_Rate_Evaluation_Data = Import_Marginal_Emissions_Rate_Evaluation_Data(Box_Sync_Directory_Location, OSESMO_Git_Repo_Directory, ...
...
[Volumetric_Rate_Data, Summer_Peak_DC, Summer_Part_Peak_DC, Summer_Noncoincident_DC, ...
    ...
    Winter_Peak_Binary_Data, Winter_Part_Peak_Binary_Data] = Import_Retail_Rate_Data(Box_Sync_Directory_Location, OSESMO_Git_Repo_Directory, ...
...
if GHG_Reduction_Solution_Input == "IOU-Proposed Charge-Discharge Time Constraints"
    ...
    [IOU_Charge_Hour_Binary_Data, IOU_Discharge_Hour_Binary_Data] = Import_IOU_Time_Constraint_Binary_Data(Box_Sync_Directory_Location, ...
...
if GHG_Reduction_Solution_Input == "No-Charging Time Constraint" || ...
 ...
 [PGE_Charge_Hour_Binary_Data, PGE_No_Charge_Hour_Binary_Data, PGE_Discharge_Hour_Binary_Data] = ...
     Import_PGE_Time_Constraint_Binary_Data(Box_Sync_Directory_Location, OSESMO_Git_Repo_Directory, delta_t);
...
if Model_Type_Input == "Solar Plus Storage"
    ...
    Solar_PV_Profile_Data = Import_Solar_PV_Profile_Data(Box_Sync_Directory_Location, OSESMO_Git_Repo_Directory, delta_t, ...
