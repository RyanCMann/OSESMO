...
% as well as for LADWP using WattTime methodology.
...
elseif contains(Retail_Rate_Name_Input, "SCE") || contains(Retail_Rate_Name_Input, "SDG&E") % || contains(Retail_Rate_Name_Input, "LADWP")
