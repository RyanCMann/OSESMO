...
% File Name: C_and_I_LADWP_A2B_Iterations.m
% File Location: "~/Desktop/OSESMO Git Repository"
% Project: Open-Source Energy Storage Model (OSESMO)
% Description: Iterates thorugh all LADWP A-2B (OLD) commercial and industrial model runs.
...
for Model_Type_Input = Model_Type_Input_Iter
    ...
    % Select all load profiles previously mapped to SCE rates for LADWP modeling.
    Load_Profile_Name_Input_Iter = ["Stem GreenButton SCE TOU-8B Office", ... % C3
    ...
    for Load_Profile_Name_Input = Load_Profile_Name_Input_Iter
        ...
        % Model LADWP A-2B Rate
        Retail_Rate_Name_Input_Iter = "LADWP A-2B (OLD)";
        ...
        for Retail_Rate_Name_Input = Retail_Rate_Name_Input_Iter
            ...
            for Storage_Type_Input = Storage_Type_Input_Iter
                ...
                % Use average of system sizes for SCE rates modeled, rounded to the nearest 10 kW.
                Storage_Power_Rating_Input_Iter = round(mean(Storage_Power_Rating_Input_Iter)/10) * 10;
                            ...
                            for Equivalent_Cycling_Constraint_Input = Equivalent_Cycling_Constraint_Input_Iter
                                ...
                                for Annual_RTE_Constraint_Input = Annual_RTE_Constraint_Input_Iter
                                    ...
                                    elseif GHG_Reduction_Solution_Input == "GHG Signal Co-Optimization"
                                        ...
                                        % Use SP15 emissions signals for all model runs.
